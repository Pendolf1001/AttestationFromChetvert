...
class Horse extends PackAnimals{
    ...
    public String toString(){
        if(zapryazhon){
            return String.format("%s; Horse;  data rozhdenia: %s; Zapryazhon (%d years)",this.name, this.birthDate, this.age );
        }else{
            return String.format("%s; Horse;  data rozhdenia: %s; Nezapryazhon (%d years)",this.name, this.birthDate, this.age );
        }
    }
