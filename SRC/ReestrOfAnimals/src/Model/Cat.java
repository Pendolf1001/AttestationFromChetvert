...
class Cat extends Pets{
    ...
    public String toString(){
        return String.format("%s; Cat; data rozhdenia: %s; (%d years)",this.name, this.birthDate, this.age );
    }


    void addCommand(String key, String move){
        HashMap <Integer, String> truecommands=new HashMap<>();
        truecommands.put(0, "Nositsya po comnate");
        truecommands.put(1, "Smotrit na vas i morgaet, zevaet i prodolzhaet smotret");
        truecommands.put(2, "Umivaetsya");
        truecommands.put(3, "MIAAAAAUUUUU!");
        truecommands.put(4, "MURRRR MIAAAAUUUU");
        truecommands.put(5, "Lezhit i spit");
        truecommands.put(6, "Tochit kogti");
        truecommands.put(7, "Ohotitca za muhoy");
        truecommands.put(8, "Idet po svoim delam");
        truecommands.put(9, "Idet na levo-pesn zavodit, napravo- skazku govorit");
        Random rnd= new Random();
    ...
    public String vzyatNaRuchki(){
        return String.format("%s leg na vashih rukah i murlichit", this.name);
    }
