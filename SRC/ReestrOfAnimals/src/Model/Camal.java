...
class Camal extends PackAnimals{
    private String name;
    ...
    public Camal(String name, String birthDate){
        this.name=name;
        setId();
    ...
    public String toString(){
        if(zapryazhon){
            return String.format("%s; Camal;  data rozhdenia: %s; Zapryazhon (%d years)",this.name, this.birthDate, this.age );
        }else{
            return String.format("%s; Camal;  data rozhdenia: %s; Nezapryazhon (%d years)",this.name, this.birthDate, this.age );
        }
    }
